...
//Literalemnte: acho q so precisaria:
// bSerial.write("AT+DEFAULT\r\n");
// bSerial.write("AT+RESET\r\n");
// bSerial.write("AT+NAME=Controller\r\n");
// bSerial.write("AT+ROLE1\r\n");
// bSerial.write("AT+TYPE1\r\n"); //Simple pairing
void bwait() {
  int late = 0;
  char c;
  while (true) {
